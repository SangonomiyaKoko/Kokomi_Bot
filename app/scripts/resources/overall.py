...
#             theme_png = Image.open(theme_png_path)
#             canvas.alpha_composite(theme_png, (0, 0))
#             del theme_png
#         else:
#             ...
...
#     region_png = Image.open(region_png_path)
#     region_png = region_png.resize((76, 42))
#     res_img.alpha_composite(region_png, (81+97, 142+130))
#     del region_png
